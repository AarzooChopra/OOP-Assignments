...
def main():
    ...
    S_true = getInputs()
    T, mu, A, B, C = setParameters()
    S_final, MSE_trend, A_final, B_final, C_final, mu_final, mse_final = getFit(T, mu, A, B, C)
...
def getInputs():
    ...
    data1 = open('A04_sfwr_data_03.txt', 'r')
...
def getFit(T, mu, A, B, C):
            ...
            for BCalc in B:                         #Loop for B
                for CCalc in C:                     #Loop for C
                    ...
                    for t in range(T):              #Loop for t
                        ...
                        S_hat.append(evaluateModel(T, muCalc, ACalc, BCalc, CCalc, t))
    ...
    return S_final, MSE_trend, A_final, B_final, C_final, mu_final, mse_final
                    
@jit      
def evaluateModel(T, mu, A, B, C, t):
